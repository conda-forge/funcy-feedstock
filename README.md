...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/funcy-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/funcy-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/funcy-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/funcy-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/funcy-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/funcy-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `funcy` can be installed with:

```
conda install funcy
```

It is possible to list all of the versions of `funcy` available on your platform with:
